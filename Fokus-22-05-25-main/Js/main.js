...
const li = document.querySelectorAll("li.app__section-task-list-item");
...
function ativarTemporizador(valor) {
    ...
    temporizador = setInterval(() => {
        ...
        for (let i = 0; i < li.length; i++) {
            if (soma === 0) {
                if (li[i].classList[1] === "app__section-task-list-item-active") {

                    li[i].classList.remove("app__section-task-list-item-active");
                    li[i].classList.add("app__section-task-list-item-complete");
                    paralisar();
